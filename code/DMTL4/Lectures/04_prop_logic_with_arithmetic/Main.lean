import DMTL4.Library.propLogicWithArith.semantics

open DMTL4.natArithmetic.syntax
...
def v0 : DMTL4.natArithmetic.syntax.Var := Var.mk 0   -- abstract syntax
...
def M := DMTL4.natArithmetic.syntax.Expr.var v0  -- abstract syntax
...
open DMTL4.natArithmetic.semantics
...
open DMTL4.propLogicwithArith.semantics
...
-- numeric variables
def c : DMTL4.natArithmetic.syntax.Var := ⟨ 0 ⟩     --# cats
def d : DMTL4.natArithmetic.syntax.Var := ⟨ 1 ⟩     --# dogs
def r : DMTL4.natArithmetic.syntax.Var := ⟨ 2 ⟩     --# rodents

-- numberic variable expressions
def C := DMTL4.natArithmetic.syntax.Expr.var c
def D := DMTL4.natArithmetic.syntax.Expr.var d
def R := DMTL4.natArithmetic.syntax.Expr.var r
...
#eval evalPLAExpr
        ...
        (λ _ => false)
        (λ v => match v with
          | (DMTL4.natArithmetic.syntax.Var.mk 0) => 5
          | (DMTL4.natArithmetic.syntax.Var.mk 1) => 4
          | (DMTL4.natArithmetic.syntax.Var.mk 2) => 12
          | _ => 0
        )
