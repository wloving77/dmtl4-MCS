...
// Module: DMT1.Lectures.«02_propLogic».formal.model_theory.models
...
lean_inc(x_6);
lean_inc(x_1);
x_8 = l_DMT1_lecture_prop__logic_semantics_evalExpr(x_1, x_6);
x_9 = lean_unbox(x_8);
lean_dec(x_8);
if (x_9 == 0)
{
...
lean_inc(x_12);
lean_inc(x_1);
x_14 = l_DMT1_lecture_prop__logic_semantics_evalExpr(x_1, x_12);
