...
// Module: DMT1.Lectures.L02_propLogic.formal.domain
// Imports: Init
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_DMT1_Lectures_L02__propLogic_formal_domain(uint8_t builtin, lean_object* w) {
lean_object * res;
