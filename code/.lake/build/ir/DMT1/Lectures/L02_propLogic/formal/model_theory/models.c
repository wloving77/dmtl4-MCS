...
// Module: DMT1.Lectures.L02_propLogic.formal.model_theory.models
// Imports: Init DMT1.Lectures.L02_propLogic.formal.model_theory.truth_table
#include <lean/lean.h>
...
lean_inc(x_6);
lean_inc(x_1);
x_8 = l_DMT1_lecture_propLogic_semantics_evalExpr(x_1, x_6);
x_9 = lean_unbox(x_8);
lean_dec(x_8);
if (x_9 == 0)
{
...
lean_inc(x_12);
lean_inc(x_1);
x_14 = l_DMT1_lecture_propLogic_semantics_evalExpr(x_1, x_12);
...
lean_object* initialize_DMT1_Lectures_L02__propLogic_formal_model__theory_truth__table(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_DMT1_Lectures_L02__propLogic_formal_model__theory_models(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_DMT1_Lectures_L02__propLogic_formal_model__theory_truth__table(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
