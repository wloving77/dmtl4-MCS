...
lean_object* initialize_DMT1_Lectures_L05__theoryExtensions_semantics(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_DMT1_Lectures_L05__theoryExtensions_semantics(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
